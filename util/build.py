...
def parse_arg():
    ...
    l_argparse.add_argument(
        "-j",
        nargs="?",
        default=argparse.SUPPRESS,
        dest="maxjobs",
        type=int,
        help="build jobs in parallel",
    )
    l_argparse.add_argument(
        "-f",
        action="store_true",
    ...
    l_argparse.add_argument(
        ...
        dest="pgo",
        default=False,
        help="build profile guided optimization binary",
    )
    l_argparse.add_argument(
        "--pgo-gen",
        action="store_true",
        dest="pgo",
        default=False,
        help="profile generating binary for pgo",
    )
    l_argparse.add_argument(
        "--with-lto",
        action="store_true",
    ...
    l_argparse.add_argument(
        ...
        dest="nop",
        default=False,
        help="print build command and exit",
    )
    l_argparse.add_argument(
        "-v",
        action="store_true",
        dest="verbose",
        default=False,
        help="build with verbose commands",
    )
    l_argparse.add_argument(
        "-s",
        action="store_true",
        dest="sanitize",
        default=False,
        help="build with sanitizers enabled",
    )
    l_argparse.add_argument(
        "-m",
        action="store_true",
    ...
    l_argparse.add_argument(
        ...
        dest="clang",
        default=True,
        help="Use clang to build binary",
    )
...
def main():
    ...
    if l_args.mold and platform.system() == "Darwin":
    ...
    cmd = ""
    if l_args.clang and not l_args.debug:
